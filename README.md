# Rust Programming Language (Rust) Gesture Designed Ferris (Ferris) Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Rust's Gesture Designed Ferris Trademarks Logo. They published clear
trademark guideline and supplied the required material files for it. The
...
etc). To comply with our standards, a re-draw is required.

This project re-draws Rust's Gesture Designed Ferris Trademarks Logo
specifically for 1200x1200 size.
...
Since Rust published its brand and trademark guideline, **you MUST go through
all the following to avoid any unwanted legal implications**:

* https://rustfoundation.org/policy/rust-trademark-policy

While not specified by Rust, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Rust Programming Language (Rust) Gesture Designed Ferris (Ferris) Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-rustlangestureferris-1200x1200
UUID: BD767AF6-B9ED-46B3-ACFF-A3293B5B6CB2
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-21
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-rustlanggestureferris-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH RUST PROGRAMMING LANGUAGE (RUST) TRADEMARK REQUIREMENTS
> (Refer: https://rustfoundation.org/policy/rust-trademark-policy)**.
>
